...
--
-- Host: localhost
-- Generation Time: Dec 20, 2018 at 04:13 PM
...
CREATE TABLE `background_checklist` (
...
INSERT INTO `background_checklist` (`id`, `name`, `type`, `mandatory`, `status`, `created_at`, `updated_at`) VALUES
(1, 'BA BGC Form(with passport size photograph)', 'PDF', 1, 1, NULL, NULL),
(2, 'Address Proof(Present and Permanent)', 'PDF', 1, 1, NULL, NULL),
(3, 'SSC', 'PDF', 1, 1, NULL, NULL),
(4, 'Intermediate(HSC/Diploma)', 'PDF', 1, 1, NULL, NULL),
(5, 'Graduation', 'PDF', 1, 1, NULL, NULL),
(6, 'Post-graduation', 'PDF', 1, 1, NULL, NULL),
(7, 'Mark sheets(consolidated / semester wise)', 'PDF', 1, 1, NULL, NULL),
(8, 'Provisional CertificatC', 'PDF', 1, 1, NULL, NULL),
(9, 'O.D (Original Document)', 'PDF', 1, 1, NULL, NULL),
(10, 'Offer letter (For all employers)', 'PDF', 1, 1, NULL, NULL),
(11, 'Experience Certificates(For all employers)', 'PDF', 1, 1, NULL, NULL),
(12, 'Salary last 3 months pay slips. (For all employers)', 'PDF', 1, 1, NULL, NULL),
(13, 'Recent Hike letters', 'PDF', 1, 1, NULL, NULL),
(14, 'Consultancy Offer letter', 'PDF', 1, 1, NULL, NULL),
(15, 'Bank statements(Complete tenure for all companies without any PF remittance)', 'PDF', 1, 1, NULL, NULL),
(16, 'Deputation letters (Need Client Name, Emp. code & reporting manager details)', 'PDF', 1, 1, NULL, NULL),
(17, 'PF statements', 'PDF', 1, 1, NULL, NULL),
(18, 'Form 16 (For all employers)', 'PDF', 1, 1, NULL, NULL);
...
--
-- Table structure for table `candidate_bgcheck_list_documents`
--

CREATE TABLE `candidate_bgcheck_list_documents` (
  `id` int(10) UNSIGNED NOT NULL,
  `file_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `candidate_id` int(10) UNSIGNED DEFAULT NULL,
  `bg_checklist_id` int(10) UNSIGNED DEFAULT NULL,
...
INSERT INTO `company_table` (`id`, `name`, `contact_no`, `address`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Tata Consultancy Services', '2266568484', 'MIHAN, Nagpur, Telhara, Maharashtra 441108', 1, NULL, NULL);
...
(13, '2018_11_05_163013_CreateStreams', 1),
(14, '2018_11_05_183507_CreateBasicQuestions', 1),
(15, '2018_11_13_174606_CreateScreeningResult', 1),
(16, '2018_11_15_165709_Create_candidate_user_assocs', 1),
(17, '2018_11_20_155746_Create_technical_interview_result', 1),
(18, '2018_12_10_120510_CreateCandidateJdAssoc', 1),
(19, '2018_12_10_183640_CreatePdfSetting', 1),
(20, '2018_12_19_113312_createCompany', 1),
(21, '2018_12_20_153436_create_background_checklist', 1),
(22, '2018_12_20_153623_create_checklist_doc', 1);
...
--
-- Indexes for table `background_checklist`
--
ALTER TABLE `background_checklist`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `candidate_bgcheck_list_documents`
--
ALTER TABLE `candidate_bgcheck_list_documents`
  ADD PRIMARY KEY (`id`),
  ADD KEY `candidate_bgcheck_list_documents_candidate_id_foreign` (`candidate_id`),
  ADD KEY `candidate_bgcheck_list_documents_bg_checklist_id_foreign` (`bg_checklist_id`);
...
--
-- AUTO_INCREMENT for table `background_checklist`
--
ALTER TABLE `background_checklist`
...
ALTER TABLE `basic_screening_result`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `candidate_bgcheck_list_documents`
--
ALTER TABLE `candidate_bgcheck_list_documents`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
--
-- Constraints for table `candidate_bgcheck_list_documents`
--
ALTER TABLE `candidate_bgcheck_list_documents`
  ADD CONSTRAINT `candidate_bgcheck_list_documents_bg_checklist_id_foreign` FOREIGN KEY (`bg_checklist_id`) REFERENCES `background_checklist` (`id`),
  ADD CONSTRAINT `candidate_bgcheck_list_documents_candidate_id_foreign` FOREIGN KEY (`candidate_id`) REFERENCES `candidate_details` (`id`);
