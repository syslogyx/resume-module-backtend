...
class CandidateCtrl extends BaseController
{
     ...
     */
    public function viewCandiadte($id)
    {
     ...
     */
    public function checkTokenExit($token)
    {
     ...
     */
    public function getCandidateListByJobId($job_id)
    {
    ...
    public function checkMobilePresent($mobileNumber)
    {
    ...
    public function checkPanNumberPresent($panNumber)
    {
